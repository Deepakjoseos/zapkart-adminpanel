...
export const LINKS = {
  ...
  editBrand: '/catalog/brands/brand',
  addBrand: '/catalog/brands/add-brand',
  addProductTemplate: '/catalog/productsTemplate/add-productsTemplate',
  editProductTemplate: '/catalog/productsTemplate/edit-productsTemplate',
  offersList: '/offers',
  addOffer: '/offers/add-offer',
  addCategory: '/catalog/category/add-category',
  category: '/catalog/category',
...
export const CATALOG_API_URL = {
  // attributeUrl: 'http://localhost:3002/api/attributesGroup',
  // Changed
  getBrands: '/api/v1/brand',
  getAttributes: '/api/v1/attribute',
  getInformations: '/api/v1/information',
  getCategories: '/api/v1/category',
  getProductTemplate: '/api/v1/productTemplate',
