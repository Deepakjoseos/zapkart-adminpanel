...
const routes = [
  ...
  // Catalog/Category
  {
    ...
    component: loadable(() => import('pages/catalog/category/list')),
    exact: true,
  },
  {
    path: `${LINKS.category}/edit/:id`,
    // component: loadable(() => import('pages/catalog/category/category-edit')),
    component: loadable(() => import('pages/catalog/category/add-edit')),
    exact: true,
  },
  {
    path: '/catalog/category/add-category',
  ...
  // Catalog/Products
  {
    ...
    component: loadable(() => import('pages/catalog/products/list')),
    exact: true,
  },
  // product pricing table
  {
    path: '/catalog/products/:id/pricingTable',
    component: loadable(() => import('pages/merchantPricingTable')),
    exact: true,
  },
  {
    path: `${LINKS.editProduct}/:id`,
    component: loadable(() => import('pages/catalog/products/add-edit')),
    exact: true,
  },
  {
    path: `${LINKS.addProduct}`,
    component: loadable(() => import('pages/catalog/products/add-edit')),
    exact: true,
  },
  ...
  {
    path: '/catalog/productsTemplate',
    component: loadable(() => import('pages/catalog/productsTemplate/list')),
    exact: true,
  },
  {
    path: `${LINKS.editProductTemplate}/:id`,
    component: loadable(() => import('pages/catalog/productsTemplate/add-edit')),
    exact: true,
  },
  {
    path: `${LINKS.addProductTemplate}`,
    component: loadable(() => import('pages/catalog/productsTemplate/add-edit')),
    exact: true,
  },
  ...
  {
    path: LINKS.informations,
    component: loadable(() => import('pages/informations/list')),
    exact: true,
  },
  {
    path: LINKS.addInformations,
    component: loadable(() => import('pages/informations/add-edit')),
    exact: true,
  },
  {
    path: `${LINKS.informations}/edit/:id`,
    component: loadable(() => import('pages/informations/add-edit')),
    exact: true,
  },
  {
  ...
  {
    path: LINKS.banners,
    component: loadable(() => import('pages/banners/list')),
    exact: true,
  },
  {
    path: LINKS.addBanners,
    component: loadable(() => import('pages/banners/add-edit-banner')),
    exact: true,
  },
  {
    path: `${LINKS.banners}/edit/:id`,
    component: loadable(() => import('pages/banners/add-edit-banner')),
    exact: true,
  },
  // {
  ...
  // /cataglog/safetyAdvice
  {
    path: '/catalog/safetyAdvice/',
    component: loadable(() => import('pages/catalog/safetyAdvice')),
    exact: true,
  },
  {
    path: `/catalog/safetyAdvice/edit/:id`,
    component: loadable(() => import('pages/catalog/safetyAdvice/add-edit')),
    exact: true,
  },
  {
    path: '/catalog/safetyAdvice/create',
    component: loadable(() => import('pages/catalog/safetyAdvice/add-edit')),
    exact: true,
  },
  // /catalog/therepyClass
  {
    path: '/catalog/therepyClass/',
    component: loadable(() => import('pages/catalog/therepyClass/list')),
    exact: true,
  },
  {
    path: `/catalog/therepyClass/edit/:id`,
    component: loadable(() => import('pages/catalog/therepyClass/add-edit')),
    exact: true,
  },
  {
    path: '/catalog/therepyClass/create',
    component: loadable(() => import('pages/catalog/therepyClass/add-edit')),
    exact: true,
  },
  ...
  {
    path: '/catalog/brands',
    component: loadable(() => import('pages/catalog/brands/list')),
    exact: true,
  },
  {
    path: '/catalog/brands/brand/:id',
    component: loadable(() => import('pages/catalog/brands/add-edit')),
    exact: true,
  },
  {
    path: '/catalog/brands/add-brand',
    component: loadable(() => import('pages/catalog/brands/add-edit')),
    exact: true,
  },
  ...
  // {
  //   path: '/gift/create',
  //   component: loadable(() => import('pages/giftCard/add-edit')),
  //   exact: true,
  // },
  // {
  //   path: '/gift/edit/:id',
  ...
  // {
  //   path: '/gift',
  //   component: loadable(() => import('pages/giftCard')),
  //   exact: true,
  // },
  // /shipment
  // {
  ...
  {
    path: '/merchantRequest',
    component: loadable(() => import('pages/merchantRequest')),
    exact: true,
  },
  // {
  //   path: '/merchant/commission/:type/list',
  ...
  {
    path: LINKS.catalogbanners,
    component: loadable(() => import('pages/catalog/banners/list')),
    exact: true,
  },
  {
    path: `${LINKS.catalogbanners}/create`,
    component: loadable(() => import('pages/catalog/banners/add-edit-banner')),
    exact: true,
  },
  {
    path: `${LINKS.catalogbanners}/edit/:id`,
    component: loadable(() => import('pages/catalog/banners/add-edit-banner')),
    exact: true,
  },
  {
