   ...
   const [vendorId,setVendorId] = useState(null)
    ...
    const fetchDeliveryZoneById = async () => {
      ...
      if (data) {
        ...
        history.replace('/app/dashboards/deliverylocation/deliveryzone/deliveryzone-list')
      }
    }
    ...
    const onAddHandler = async (deliveryZoneId, deliveryLocationId,vendorId) => {
    ...
    const onDeleteHandler = async (deliveryZoneId, deliveryLocationId,vendorId) => {
      ...
      <Card title={deliveryZoneTitle}>
        <Flex>
          ...
          <Button
            ...
            onClick={() => onAddHandler(id, selectedDeliveryLocationId,vendorId)}
          />
        </Flex>
          ...
          <List
            ...
            renderItem={(item, i) => (
              <List.Item key={i}>
                ...
                <Button
                  icon={<DeleteOutlined />}
                  onClick={() => onDeleteHandler(id, item.id,vendorId)}
                />
              </List.Item>
            )}
          />
