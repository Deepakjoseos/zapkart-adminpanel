...
import walletService from 'services/Wallet'
  ...
  const { Option } = Select
  const RemoveBalanceForm = ({
    setRe,
    removeBalanceForm,
    setRemoveBalanceForm,
    // form,
    // openWithdrawBalance,
    ...
    const onFinish = async () => {
      ...
      form
        ...
        .then(async (values) => {
          ...
          const created =
            await walletService.removeBalanceFromWallet(
                
              sendingValues
            )
          if (created) {
            message.success(`Removed ${values.amount} from Wallet `)
            setRemoveBalanceForm(false)
    ...
    return (
      ...
      >
        <Form
          ...
          hideRequiredMark
        >
          <Card title="Remove Balnce From Wallet">
  ...
  export default RemoveBalanceForm