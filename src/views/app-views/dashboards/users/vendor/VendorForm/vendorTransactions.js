...
const VendorTransactions = ({
  ...
  return (
    <>
          ...
          <div>
            <Flex justifyContent="end">
              ...
              <Button
                ...
                type="primary"
                onClick={() => {
                  setRemoveBalanceForm(true)
                }}
              >
                {' '}
                Remove Balance to From Wallet
              </Button>
      ...
      />
      <AddBalancetoWallet
        setAddBalanceForm={setAddBalanceForm}
        addBalanceForm={addBalanceForm}
        selectedVendorId={selectedVendorId}
      />
      <RemoveBalanceForm
        selectedVendorId={selectedVendorId}
        removeBalanceForm={removeBalanceForm}
        setRemoveBalanceForm={setRemoveBalanceForm}
      />
    </>
  )
}
