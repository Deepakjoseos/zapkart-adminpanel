...
export const safetyAdvice = Yup.object().shape({
  name: Yup.string().required('Required'),
  status: Yup.string().required('Required'),
  priorityOrder: Yup.string().nullable(),
  icon: Yup.array()
    .nullable()
...
export const deliveryAdminLocationSchema = Yup.object().shape({
  ...
  locality_type: Yup.string().required('Required'),
  status: Yup.string().required('Required'),
  zone_type: Yup.string().required('Required'),
  // zipcode: Yup.string().required('Required'),
  locality_district: Yup.string().nullable(),
  // country: Yup.string().nullable().required('Required'),
  locality_state: Yup.string().nullable(),
  merchantId: Yup.string().required('Required'),
  pincodes: Yup.string().nullable(),
  // checkbox: Yup.boolean.test('string').required('Required')
})
...
export const merchantRequestSchema = Yup.object().shape({
  name: Yup.string().required('Required'),
  firstName: Yup.string().required('Required'),
  lastName: Yup.string().nullable().required('Required'),
  email: Yup.string().email('Email is not valid').required('Required'),
...
export const therepySchema = Yup.object().shape({
  name: Yup.string().required('Required'),
...
export const productCustomAttributesSchema = Yup.object().shape({
  attribute: Yup.string().test((val) => {
    console.log('Select shailesh', val)
  }),
})
...
export const productGeneralSchema = Yup.object().shape({
  ...
  // medicinetype: Yup.string().required(),
...
export const SafetyAdviceSchema = Yup.object().shape({
  safety_advice: Yup.string().required('Required'),
  therapeutic_class: Yup.string().required('Required'),
  habitForming: Yup.string().required('Required'),
})
export const productSchema = Yup.mixed()
  .concat(productGeneralSchema)
  .concat(productShippingSchema)
  .concat(seoSchema)
  .concat(pricingSchema)
  .concat(attributesListSchema)
  .concat(prodDescrSchema)
// .concat(productCustomAttributesSchema)
// .concat(SafetyAdviceSchema)
...
export const merchantSchema = Yup.mixed()
  .concat(merchantGeneralSchema)
...
export const productTemplateSchema = Yup.object().shape({
  name: Yup.string().required('Required'),
  images: Yup.string().required('Required'),
  // status: Yup.string().required(),
  description: Yup.string().required('Required'),
  productType: Yup.string().required('Required'),
  allowedPaymentTypes: Yup.array().required('Required'),
  returnable: Yup.boolean().required('Required'),
