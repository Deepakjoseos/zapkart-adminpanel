...
import { getBanners, editBannersStatus, deleteBanner } from 'services/catalogBanner'
...
class BannersList extends React.Component {
  ...
  render() {
    ...
    const { tableData, selectedRowKeys, loading, pagination } = this.state
    // const rowSelection = {
    //   selectedRowKeys,
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (record) => (
          <span>
            <Link to={`${LINKS.catalogbanners}/edit/${record._id}`}>
          ...
          <div className="card-header">
            <div className="utils__title">
              ...
              <AddNew
                ...
                attribute="banner"
                link={`${LINKS.catalogbanners}/create`}
