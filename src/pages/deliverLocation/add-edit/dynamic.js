...
const Demo = (props) => {
  ...
  // }
  useEffect(() => {
    console.log('PRops', props, inputFields)
    if (props.values) {
      const setP = props.values ? props.values.some((item) => typeof item === 'object') : false
        // const obj=[...props.values]

      if (setP) {
       
        // setInputFields([...obj,...inputFields])
        setInputFields(props.values)
      }
      // setInputFields([inputFields,...props.values])
